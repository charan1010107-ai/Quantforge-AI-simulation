...
import { Zap, Eye, EyeOff, ArrowRight, Shield, Brain, TrendingUp } from 'lucide-react'
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-10 max-w-md">
              Experience the future of portfolio management with AI-powered agents 
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Shield, text: 'Enterprise-Grade Risk Management' },
